...
const Dashboard: React.FC = () => {{
    const sidebarItems = [{"label": "Prospects", "icon": "person_search", "path": "/admission-officer/prospects"}, {"label": "Applications", "icon": "assignment", "path": "/admission-officer/applications"}, {"label": "Admissions", "icon": "how_to_reg", "path": "/admission-officer/admissions"}];
        ...
        <Layout sidebarItems={{sidebarItems}}>
            <div className="flex flex-col gap-10">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-4xl font-black text-slate-800 tracking-tight capitalize">{admission officer} Dashboard</h1>
