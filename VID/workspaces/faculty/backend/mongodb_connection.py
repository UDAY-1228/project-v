"""
Faculty - MongoDB Connection
============================
Async MongoDB connection using Motor for the Faculty workspace.
"""
...
logger = logging.getLogger("faculty.db")
...
async def connect_to_database():
    ...
    try:
        ...
        logger.info(f"✅ Faculty DB connected → {DB_NAME}")
...
async def close_database_connection():
    ...
    if client:
        client.close()
        logger.info("🔌 Faculty DB connection closed")
