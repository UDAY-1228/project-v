...
const Dashboard: React.FC = () => {{
    const sidebarItems = [{"label": "Digital Notice Board", "icon": "announcement", "path": "/transport-coordinator/notice-board"}, {"label": "Transport Analytics", "icon": "bar_chart", "path": "/transport-coordinator/analytics"}, {"label": "Transport Registrations", "icon": "app_registration", "path": "/transport-coordinator/registrations"}, {"label": "Buses", "icon": "directions_bus", "path": "/transport-coordinator/buses"}, {"label": "Boarding Points", "icon": "place", "path": "/transport-coordinator/boarding"}, {"label": "Routes", "icon": "map", "path": "/transport-coordinator/routes"}, {"label": "Route Bus Assignment", "icon": "assignment", "path": "/transport-coordinator/assignment"}, {"label": "Configuration", "icon": "settings", "path": "/transport-coordinator/config"}];
        ...
        <Layout sidebarItems={{sidebarItems}}>
            <div className="flex flex-col gap-10">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-4xl font-black text-slate-800 tracking-tight capitalize">{transport coordinator} Dashboard</h1>
