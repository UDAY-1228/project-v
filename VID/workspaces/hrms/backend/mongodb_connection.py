"""
HRMS - MongoDB Connection
==========================
Async MongoDB connection using Motor for the HRMS workspace.
"""
...
logger = logging.getLogger("hrms.db")

MONGO_URI = os.getenv("MONGO_URI", "mongodb://localhost:27017")
DB_NAME = os.getenv("DB_NAME", "vid_db")
COLLECTION_PREFIX = "hrms_"
...
async def connect_to_database():
    ...
    try:
        ...
        logger.info(f"✅ HRMS DB connected → {DB_NAME}")
...
async def close_database_connection():
    ...
    if client:
        client.close()
        logger.info("🔌 HRMS DB connection closed")
