"""
Common - MongoDB Connection
============================
Async MongoDB connection using Motor for the Common workspace.
"""
...
COLLECTION_PREFIX = "cm_"  # Common prefix
...
async def connect_to_database():
    ...
    try:
        ...
        logger.info(f"✅ Common DB connected → {DB_NAME}")
...
async def close_database_connection():
    ...
    if client:
        client.close()
        logger.info("🔌 Common DB connection closed")
