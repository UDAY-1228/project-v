...
const Dashboard: React.FC = () => {{
    const sidebarItems = [{"label": "Home", "icon": "home", "path": "/common/home"}, {"label": "Student Central", "icon": "school", "path": "/common/student-central"}, {"label": "My Requests", "icon": "rate_review", "path": "/common/requests"}, {"label": "Payments", "icon": "payments", "path": "/common/payments"}, {"label": "Exams", "icon": "assessment", "path": "/common/exams"}, {"label": "HRMS", "icon": "badge", "path": "/common/hrms"}, {"label": "Configurations", "icon": "settings", "path": "/common/config"}];
