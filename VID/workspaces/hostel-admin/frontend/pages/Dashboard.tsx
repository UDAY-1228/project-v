...
const Dashboard: React.FC = () => {{
    const sidebarItems = [{"label": "Dashboard", "icon": "dashboard", "path": "/hostel-admin/dashboard"}, {"label": "Hostelers", "icon": "hotel", "path": "/hostel-admin/hostelers"}, {"label": "Attendance", "icon": "check_circle", "path": "/hostel-admin/attendance"}, {"label": "Gate Pass Requests", "icon": "key", "path": "/hostel-admin/gatepass"}, {"label": "Reports", "icon": "analytics", "path": "/hostel-admin/reports"}, {"label": "Configuration", "icon": "settings", "path": "/hostel-admin/config"}];
        ...
        <Layout sidebarItems={{sidebarItems}}>
            <div className="flex flex-col gap-10">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-4xl font-black text-slate-800 tracking-tight capitalize">{hostel admin} Dashboard</h1>
