...
const Dashboard: React.FC = () => {{
    const sidebarItems = [{"label": "Notice Board", "icon": "announcement", "path": "/student/notice-board"}, {"label": "My Attendance", "icon": "check_circle", "path": "/student/attendance"}, {"label": "Events", "icon": "event", "path": "/student/events"}, {"label": "LMS", "icon": "auto_stories", "path": "/student/lms"}, {"label": "Exams", "icon": "assignment", "path": "/student/exams"}, {"label": "Assessments", "icon": "quiz", "path": "/student/assessments"}, {"label": "Question Bank", "icon": "menu_book", "path": "/student/questions"}, {"label": "Fee Payments", "icon": "payments", "path": "/student/payments"}, {"label": "My Profile", "icon": "person", "path": "/student/profile"}, {"label": "Calendar", "icon": "calendar_month", "path": "/student/calendar"}];
        ...
        <Layout sidebarItems={{sidebarItems}}>
            <div className="flex flex-col gap-10">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-4xl font-black text-slate-800 tracking-tight capitalize">{student} Dashboard</h1>
