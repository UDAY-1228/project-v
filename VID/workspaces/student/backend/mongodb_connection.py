"""
Student Workspace - MongoDB Connection
======================================
Async MongoDB connection using Motor for the Student workspace.
"""
...
logger = logging.getLogger("student.db")

MONGO_URI = os.getenv("MONGO_URI", "mongodb://localhost:27017")
DB_NAME = os.getenv("DB_NAME", "vid_db")
COLLECTION_PREFIX = "stu_"
...
async def connect_to_database():
    ...
    try:
        ...
        logger.info(f"✅ Student DB connected → {DB_NAME}")
...
async def close_database_connection():
    ...
    if client:
        client.close()
        logger.info("🔌 Student DB connection closed")
