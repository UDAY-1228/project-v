"""
Voice Agent - MongoDB Connection
==================================
Async MongoDB connection using Motor for the Voice Agent workspace.
"""
...
async def connect_to_database():
    ...
    try:
        ...
        logger.info(f"✅ Voice Agent DB connected → {DB_NAME}")
...
async def close_database_connection():
    ...
    if client:
        client.close()
        logger.info("🔌 Voice Agent DB connection closed")
