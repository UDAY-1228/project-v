...
const Dashboard: React.FC = () => {{
    const sidebarItems = [{"label": "Digital Notice Board", "icon": "announcement", "path": "/academic-coordinator/notice-board"}, {"label": "Activities", "icon": "event", "path": "/academic-coordinator/activities"}, {"label": "Course Registrations", "icon": "how_to_reg", "path": "/academic-coordinator/registrations"}, {"label": "Student Promotions", "icon": "trending_up", "path": "/academic-coordinator/promotions"}, {"label": "All Students", "icon": "groups", "path": "/academic-coordinator/students"}, {"label": "Question Banks", "icon": "quiz", "path": "/academic-coordinator/questions"}, {"label": "Courses", "icon": "menu_book", "path": "/academic-coordinator/courses"}, {"label": "Attendance", "icon": "check_circle", "path": "/academic-coordinator/attendance"}, {"label": "Classrooms", "icon": "meeting_room", "path": "/academic-coordinator/classrooms"}, {"label": "Reports", "icon": "analytics", "path": "/academic-coordinator/reports"}, {"label": "Faculty Timetable", "icon": "event_note", "path": "/academic-coordinator/timetable"}];
        ...
        <Layout sidebarItems={{sidebarItems}}>
            <div className="flex flex-col gap-10">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-4xl font-black text-slate-800 tracking-tight capitalize">{academic coordinator} Dashboard</h1>
