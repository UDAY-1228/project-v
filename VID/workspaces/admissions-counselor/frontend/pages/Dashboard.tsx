...
const Dashboard: React.FC = () => {{
    const sidebarItems = [{"label": "Prospects", "icon": "person_search", "path": "/admissions-counselor/prospects"}, {"label": "Applications", "icon": "assignment", "path": "/admissions-counselor/applications"}, {"label": "Admissions", "icon": "how_to_reg", "path": "/admissions-counselor/admissions"}, {"label": "Configurations", "icon": "settings", "path": "/admissions-counselor/config"}];
        ...
        <Layout sidebarItems={{sidebarItems}}>
            <div className="flex flex-col gap-10">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-4xl font-black text-slate-800 tracking-tight capitalize">{admissions counselor} Dashboard</h1>
