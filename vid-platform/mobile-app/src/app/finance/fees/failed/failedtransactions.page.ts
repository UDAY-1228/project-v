  ...
  template: `
    <ion-header [translucent]="true">
      <ion-toolbar color="primary">
        ...
        <ion-title>FailedTransactions</ion-title>
      </ion-toolbar>
    </ion-header>

    <ion-content [fullscreen]="true" class="ion-padding">
      <div class="welcome-card ion-margin-bottom">
        <h2 class="ion-no-margin font-bold text-2xl text-primary">FailedTransactions</h2>
...
export class FailedTransactionsPage implements OnInit {
  constructor() { }
  ngOnInit() { }
}
