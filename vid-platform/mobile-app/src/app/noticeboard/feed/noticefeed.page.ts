  ...
  template: `
    <ion-header [translucent]="true">
      <ion-toolbar color="primary">
        ...
        <ion-title>NoticeFeed</ion-title>
      </ion-toolbar>
    </ion-header>

    <ion-content [fullscreen]="true" class="ion-padding">
      <div class="welcome-card ion-margin-bottom">
        <h2 class="ion-no-margin font-bold text-2xl text-primary">NoticeFeed</h2>
...
export class NoticeFeedPage implements OnInit {
  constructor() { }
  ngOnInit() { }
}
